...
URL_SCRIPT = "ضف_رابط_السكريبت_الجديد_هنا"
URL_SHEET_CSV = "ضف_رابط_الـCSV_هنا"
...
st.markdown("""
    ...
    .stat-box { background: rgba(255, 255, 255, 0.05); padding: 15px; border-radius: 12px; border: 1px solid #f1c40f; text-align: center; }
...
def fetch_data():
    try:
        ...
        # تصحيح الأعمدة إذا كان هناك إزاحة [cite: 2026-02-20]
...
with tab2:
    if st.text_input("كلمة السر", type="password") == "Zewail2026":
        ...
        if not df.empty:
            ...
            # فلاتر الكشوفات [cite: 2026-02-18]
            st.markdown("---")
